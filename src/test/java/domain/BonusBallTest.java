...
class BonusBallTest {
	...
	void 보너스_번호는_로또_번호의_범위_내에_있어야_한다() {
		...
		assertThatThrownBy(() -> BonusBall.createBonusBallInRange(lottoNumberRange, 50, winningNumbers))
	...
	void 보너스_번호는_당첨_번호와_중복될_수_없다(int input) {
		...
		assertThatThrownBy(() -> BonusBall.createBonusBallInRange(lottoNumberRange, input, winningNumbers))
			.isInstanceOf(IllegalArgumentException.class)
